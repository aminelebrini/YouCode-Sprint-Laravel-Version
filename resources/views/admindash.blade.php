                            ...
                            @foreach($users as $user)
                                ...
                                <tr class="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                                    ...
                                    <td class="p-8 text-right space-x-2">
                                        <button onclick="toggleModal('EditProfileModal')" data-id="{{ $user->getId() }}"  class="w-8 h-8 rounded-lg bg-white/5 hover:bg-cyan-400/20 hover:text-cyan-400 transition-all text-white/40"><i class="fas fa-edit"></i></button>
